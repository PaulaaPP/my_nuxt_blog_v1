...
const { data } = await useAsyncData(`contnet-${path}`, () => {
...
<template>
  ...
  <div class="my-8">
    <a
      ...
      :key="tag"
      :href="`/blog/tags/${tag}`"
      class="text-sm font-semibold inline-block py-2 px-4 rounded-lg text-gray-100 bg-red-500 uppercase last:mr-0 mr-4"
    >
